...
class ExcelExtractorApp:
    ...
    def run_extraction(self):
        ...
        try:
            ...
            result = self.search_and_extract(processed_file, search_term)
    ...
    def unhide_and_convert_values(self, file_path):
        ...
        try:
            ...
            if hidden_sheets:
                self.log(f"   ✅ 显示了 {len(hidden_sheets)} 个隐藏的工作表")
    ...
    def search_and_extract(self, file_path, search_term):
        """搜索并提取数据"""
        try:
