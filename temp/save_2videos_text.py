...
ws1['A5'] = "话题标签"
ws1['B5'] = "#干货分享 #推拉技巧 #情绪价值 #恋爱心理学 #恋爱"
ws1['A6'] = "作者"
ws1['B6'] = "灯哥说脱单"
ws1['A7'] = "视频时长"
ws1['B7'] = "04:22"
ws1['A8'] = "提取时间"
ws1['B8'] = datetime.now().strftime("%Y-%m-%d %H:%M:%S")

ws1['A10'] = "完整文案内容"
ws1['A10'].font = Font(bold=True, size=12)
ws1['A11'] = video1_text
ws1['A11'].alignment = Alignment(wrap_text=True)

ws1.column_dimensions['A'].width = 15
ws1.column_dimensions['B'].width = 80

# Sheet 2: 视频 2
ws2 = wb.create_sheet("视频 2-防御性驾驶")
...
ws2['A5'] = "话题标签"
ws2['B5'] = "#知识科普 #防御性驾驶 #政务原创作者联盟 #开车技巧"
ws2['A6'] = "作者"
ws2['B6'] = "抚州交警"
ws2['A7'] = "视频时长"
ws2['B7'] = "00:45"
...
ws2['A11'] = video2_text
ws2['A11'].alignment = Alignment(wrap_text=True)

ws2.column_dimensions['A'].width = 15
ws2.column_dimensions['B'].width = 80

# Sheet 3: 对比汇总
ws3 = wb.create_sheet("文案对比")

ws3['A1'] = "视频文案对比"
ws3['A1'].font = Font(bold=True, size=14)

headers = ["项目", "视频 1-推拉技巧", "视频 2-防御性驾驶"]
for col, header in enumerate(headers, start=1):
    ws3[f'{chr(64+col)}1'] = header
    ws3[f'{chr(64+col)}1'].font = Font(bold=True)

data = [
    ("视频链接", "https://v.douyin.com/KE4eK_vzT0Y/", "https://v.douyin.com/oCbxegyfZhk/"),
    ("作者", "灯哥说脱单", "抚州交警"),
    ("时长", "04:22", "00:45"),
    ("字数", str(len(video1_text)), str(len(video2_text))),
    ("类型", "恋爱教学", "驾驶教学"),
    ("标签", "#干货分享 #推拉技巧", "#知识科普 #防御性驾驶")
]

for row, (item, v1, v2) in enumerate(data, start=2):
    ws3[f'A{row}'] = item
    ws3[f'B{row}'] = v1
    ws3[f'C{row}'] = v2
...
# 保存
output_file = "/home/admin/openclaw/workspace/output/抖音视频完整文案_2 个视频.xlsx"
wb.save(output_file)
...
print(f"   总计：{len(video1_text) + len(video2_text)} 字")
